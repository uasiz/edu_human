...
public class RouteorderDto implements Serializable{
	...
	public RouteorderDto(String routeid, String nodeid, String nodeord) {
		//서버에서 씀
		super();
	...
	public RouteorderDto(String nodeid, String nodenm, String routeord, String routeid, Boolean check) {
		super();
		this.nodeid = nodeid;
		this.nodenm = nodenm;
